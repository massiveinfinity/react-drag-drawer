...
var _reactIntersectionObserver2 = _interopRequireDefault(
  _reactIntersectionObserver
);
...
var Drawer = ((_temp2 = _class = (function(_Component) {
  ...
  function Drawer() {
    ...
    return (
      ...
      (_this.tap = function(event) {
        ...
        var start =
          (0, _helpers.isDirectionBottom)(_this.props.direction) ||
          (0, _helpers.isDirectionTop)(_this.props.direction)
            ? pageY
            : pageX;
      ...
      (_this.drag = function(event) {
        ...
        var movingPosition =
          (0, _helpers.isDirectionBottom)(direction) ||
          (0, _helpers.isDirectionTop)(direction)
            ? pageY
            : pageX;
        var delta = movingPosition - thumb;
        var newPosition = (0, _helpers.isDirectionBottom)(direction)
          ? position + delta
          : position - delta;
      ...
      (_this.getElementSize = function() {
        if ((0, _helpers.isClientSide)()) {
          return (0, _helpers.isDirectionBottom)(_this.props.direction) ||
            (0, _helpers.isDirectionTop)(_this.props.direction)
            ? window.innerHeight
            : window.innerWidth;
        }
  ...
  Drawer.prototype.render = function render() {
    ...
    return (0, _reactDom.createPortal)(
      _react2.default.createElement(
        _reactMotion.Motion,
        {
          style: {
            translate: (0, _reactMotion.spring)(
              open ? position : hiddenPosition,
              animationSpring
            )
          },
          defaultStyle: {
...
Drawer.propTypes =
  process.env.NODE_ENV !== "production"
    ? {
        ...
        modalElementClass: _propTypes2.default.oneOfType([
          _propTypes2.default.object,
          _propTypes2.default.string
        ]),
        containerOpacity: _propTypes2.default.number,
